    ...
    <Parallax pages={6}>
      <Divider speed={0.2} offset={0}>
        <UpDown>
          ...
          <SVG icon="lettert" width={50} stroke={colors.orange} left="60%" top="15%" />
        </UpDown>
        <UpDownWide>
      ...
      <Content speed={0.4} offset={2.6} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            ...
            >
              Full Stack Development: Front and Back using Node JS. Using MERN Development (MongoDB, Express, React, NodeJs).
            </ProjectCard>
            <ProjectCard
              title="Cloud Server (SaaS) Stack"
            ...
            <ProjectCard
              title="Custom WordPress Themes and Custom plugins"
              link="https://www.behance.net/gallery/38068151/Eagle"
              bg="linear-gradient(to right, #D585FF 0%, #00FFEE 100%)"
            >
              More control over a Wordpress build from start to finish.
            </ProjectCard>
          </ProjectsWrapper>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={5}>
        <Inner>
          ...
          <ContactText>
            ...
            or email me at
            <a href="mailto:neil@wordsco.uk"> neil@wordsco.uk</a>
          </ContactText>
        </Inner>
        <Footer>
          &copy; 2019 Wordsco - Company of Words.
